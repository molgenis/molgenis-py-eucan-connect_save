        ...
        stage('Release: [ main ]') {
            ...
            steps {
                ...
                container('python') {
                    ...
                    hubotSend(message: "${REPOSITORY} ${NEW_PACKAGE_VERSION} has been released! :tada: https://pypi.org/project/${REPOSITORY}/", status:'SUCCESS')
                }
            }
        }
    }
